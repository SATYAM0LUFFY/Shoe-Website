...
const AboutUs = () => {
  return (
    <div className='flex justify-evenly mt-40 mb-48 w-full pt-20 scroll-mt-20 md:flex-row flex-col' id='aboutus'>
      ...
      <div className='max-w-[505px]'>
        <h1 className='font-bold text-4xl mb-5 md:mt-0  mt-10 md:mx-0 mx-8'>About Us!</h1>
